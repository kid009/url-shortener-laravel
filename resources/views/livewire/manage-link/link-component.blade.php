                        ...
                        <button type="submit"
                            ...
                            <span wire:loading wire:target='save'>
                                <svg aria-hidden="true"
                                    class="inline w-4 h-4 w-8 h-8 text-neutral-tertiary animate-spin fill-brand"
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form wire:submit="search">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="search_url" class="block mb-2.5 text-sm font-medium text-heading">Search
                                    URL</label>
                                <input type="text" wire:model='search_url'
                                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" />
                            </div>
                            <div>
                                <label for="search_created_date"
                                    class="block mb-2.5 text-sm font-medium text-heading">Search Created Date</label>
                                <input type="date" wire:model='search_created_date'
                                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" />
                            </div>
                            <div>
                                <label for="search_created_by"
                                    class="block mb-2.5 text-sm font-medium text-heading">Search Created By</label>
                                <input type="text" wire:model='search_created_by'
                                    class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body" />
                            </div>
                        </div>
                        ...
                        <a href="{{ route('manage-links') }}" wire:navigate
